...
.fbm_loop:
    ...
    movss   xmm0, [rbp-24]
    addss   xmm0, xmm0
    movss   [rbp-24], xmm0       ; x *= 2
    movss   xmm0, [rbp-20]
    addss   xmm0, xmm0
    movss   [rbp-20], xmm0       ; z *= 2
...
.gh_i:
    ...
    movss       [rbp-32], xmm0   ; save wx
    movss       [rbp-28], xmm1   ; save wz
...
.wv_i:
    ...
    movss       [rbp-76], xmm2  ; pos.y
    movss       [rbp-72], xmm1  ; pos.z
    ...
    movss       xmm5, [r15 + rax*4]
    movss       [rbp-40], xmm5
    mov         dword [rbp-36], 0x3F800000  ; 1.0f (alpha)
